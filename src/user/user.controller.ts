...
export class UserController {
  ...
  @ApiOperation({
    summary: 'Route to register users.',
  ...
  @ApiOperation({
    summary: 'Route to returns a user.',
  ...
  @ApiOperation({
    summary: 'Route to update partial a user.',
  ...
  @ApiOperation({
    summary: 'Route to remove a user.',
